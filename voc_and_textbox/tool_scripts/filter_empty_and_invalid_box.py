...
def filter_invalid_xml(xml_folder, image_folder,filtered_xml_folder):
    ...
    for xml_name in os.listdir(xml_folder):
        ...
        #todo:这里根据需要定制
        if xml_reader.width < 10 or xml_reader.height < 10:
            empty_num += 1
            continue
        else:
...
if __name__ == '__main__':
    xml_folder = '/home/wz/Data/VIN/drving_license_cut/Seal_Regression/TF-Mobilenet-SSD/VOC2007/Annotations'
    image_folder = '/home/wz/Data/VIN/drving_license_cut/Seal_Regression/TF-Mobilenet-SSD/VOC2007/JPEGImages'
    filtered_xml_folder = '/home/wz/Data/VIN/drving_license_cut/Seal_Regression/TF-Mobilenet-SSD/VOC2007/xml_filter'
